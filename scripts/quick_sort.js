function Quick() {
    ...
    document.getElementById("Space_Worst_case").innerText = "O(logn)";
    document.getElementById("Space_Average_case").innerText = "O(logn)";
    document.getElementById("Space_Best_case").innerText = "O(logn)";
