...
function Heap()
{
    ...
    document.getElementById("Time_Worst_case").innerText="O(N log N)";
    document.getElementById("Time_Average_case").innerText="Θ(N log N)";
    document.getElementById("Time_Best_case").innerText="Ω(N log N)";
